function getStartedContent(id) {
    ...
    <p>
    https://open-data.herokuapp.com/ is a free online <strong>REST API</strong> as well as <strong>GRAPHQL</strong> that you can use whenever you need some data. It can be in a README on GitHub, simply to test things locally.
