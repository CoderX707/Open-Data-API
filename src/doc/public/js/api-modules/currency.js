...
function currencyOprations(menuId,mainId) {
    ...
    <span class="method-bold">
        All ${menuId} [ <a href="https://mockx-api.herokuapp.com/${mainId}/v1/${menuId}">GET</a> ]:<br/> 
...
function currencyGraphQL(menuId,mainId) {
    return (`<p>
    For get ${menuId} exchange rate use following url <a href="https://mockx-api.herokuapp.com/graphql/v1/${menuId}">playground</a>:<br>
    <span class="method-bold">
