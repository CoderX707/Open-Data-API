...
function authOprations(menuId, mainId) {
    ...
    <span class="method-bold">
        Check ${menuId} [ <a target="_blank" href="https://open-data-api.onrender.com/${mainId}/v1/${menuId}">GET</a> ]:<br/> 
        <code class="higlighted break-word">https://open-data-api.onrender.com/${mainId}/v1/${menuId}</code>
        <br>
        Register ${menuId} [ POST ]:<br/> 
        <code class="higlighted break-word">https://open-data-api.onrender.com/${mainId}/v1/${menuId}/register</code>
        <br>
        Login ${menuId} [ POST ]:<br/> 
        <code class="higlighted break-word">https://open-data-api.onrender.com/${mainId}/v1/${menuId}/login</code>
        <br>
    </span>
</p>`);
}
...
function authGraphQL(menuId, mainId) {
    return (`<p>
    For ${menuId} oprations use following url <a target="_blank" href="https://open-data-api.onrender.com/graphql/v1/${menuId}">playground</a>:<br>
    <span class="method-bold">
